...
class TestFracs(unittest.TestCase):
    ...
    def test_gt(self):
        ...
        self.assertTrue(self.f3 > self.f1)
        self.assertTrue(self.f1 > 0.25)
        self.assertTrue(self.one > 0.5)
    ...
    def test_add(self):
        ...
        self.assertEqual(self.f1 + 0.5, self.one)
        self.assertEqual(self.f1 + 1, Frac(3, 2))
        self.assertEqual(0.5 + self.f1, self.one)
    ...
    def test_sub(self):
        ...
        self.assertEqual(self.f1 - 0.25, Frac(1, 4))
        self.assertEqual(self.f1 - 1, self.f2)
        self.assertEqual(1 - self.f1, Frac(1, 2))
        self.assertEqual(0.5 - self.f1, self.zero)
    ...
    def test_mull(self):
        ...
        self.assertEqual(self.f1 * 2, self.one)
        self.assertEqual(2 * self.f1, self.one)
        self.assertEqual(self.one * 0.5, self.f1)
        self.assertEqual(0.5 * self.one, self.f1)
